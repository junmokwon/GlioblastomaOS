# Original UNETR source code is copied from the MONAI repository.
# https://github.com/Project-MONAI/MONAI/blob/main/monai/networks/nets/unetr.py
...
class UNETRAE(UNETR):
    def __init__(self, *args, **kwargs):
        ...
        self.ae_out = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size, out_channels=in_channels)
    ...
    def forward(self, x_in):
        ...
        # Autoencoder part
        ae_dec3 = self.ae_decoder5(dec4, enc4)
        ae_dec2 = self.ae_decoder4(ae_dec3, enc3)
        ae_dec1 = self.ae_decoder3(ae_dec2, enc2)
        ae_lasts = self.ae_decoder2(ae_dec1, enc1)
        reconstructed = self.ae_out(ae_lasts)
        
        return self.out(out), reconstructed, ae_lasts
