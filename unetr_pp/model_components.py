...
# https://github.com/Amshaker/unetr_plus_plus/blob/main/unetr_pp/network_architecture/tumor/model_components.py
...
from monai.networks.blocks.dynunet_block import get_conv_layer, UnetResBlock
